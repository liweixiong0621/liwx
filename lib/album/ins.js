      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            ...
            var minSrc = 'https://raw.githubusercontent.com/liweixiong0621/Blog_Album/master/min_zhengshuang/' + data.link[i];
                          
            var src = 'https://raw.githubusercontent.com/liweixiong0621/Blog_Album/master/zhengshuang/' + data.link[i];
            ...
            liTmpl += '<figure class="thumb" itemprop="associatedMedia" itemscope="" itemtype="http://schema.org/ImageObject">\
                  <a href="' + minSrc + '" itemprop="contentUrl" data-size="666x999" data-type="' + type + '" data-target="' + minSrc + '">\
